...
<body>
	<jsp:include page="/WEB-INF/view/passport/top.jsp"></jsp:include>
				...
				<div class="passport_panel">
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="w-100" align="center" style="color: red"> ${message }</p>
								...
								<div class="form-group">
									<button type="submit" onclick="reg()"  class="btn btn-info">注册</button>
								<p class="w-100" align="right">
									如果已有帐号，请<a href="/toLogin">点这里登录</a>
								</p>
								</div>
	...
	<jsp:include page="/WEB-INF/view/passport/footer.jsp" />
