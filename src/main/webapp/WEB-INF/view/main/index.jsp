...
<body>
	<jsp:include page="/WEB-INF/view/main/top.jsp"></jsp:include>
			...
			<div class="col-md-7 split min_h_500">
				...
				<div id="hot">
					...
					<c:forEach items="${hotList}" var="c">
						<div class="media">
							<img class="align-self-start mr-3" src="${c.picture }"
								alt="no pic">
			...
			<div class="col-md-3">
			   ...
			   <div class="card-header">友情链接</div>
			    ...
			    <c:forEach items="${linkList}" var="l">
			      <li class="text-truncate text-center"><a href="${l.url }" target="_blank">${l.name}</a></li>
