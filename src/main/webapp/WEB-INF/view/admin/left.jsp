...
<ul class="sidebar navbar-nav" >
	...
	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="${pageContext.request.contextPath}/article/getList">
			<i class="fas fa-fw fa-folder"></i> <span>文章管理</span>
	</a></li>

	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="${pageContext.request.contextPath}/getUserList">
	...
	<li class="nav-item"><a class="nav-link" href="javascript:void(0)" data="/frendlyLink/toList">
